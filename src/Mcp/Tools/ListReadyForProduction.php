...
#[Description('List YouTrack issues that have passed staging review and are ready to be batched into a production deploy.')]
#[IsReadOnly]
class ListReadyForProduction extends Tool
{
    ...
    public function handle(Request $request): Response
    {
        ...
        $issues = $this->service($request)->listReadyForProduction($project)->values()->all();
