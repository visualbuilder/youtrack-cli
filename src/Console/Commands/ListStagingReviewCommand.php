...
class ListStagingReviewCommand extends ListByStateCommand
{
    protected $signature = 'youtrack:list-staging-review
    ...
    protected $description = 'List YouTrack issues under review on staging';
